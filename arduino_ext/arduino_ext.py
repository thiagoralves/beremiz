...
from arduino_ext.CFileEditor import CFileEditor
...
class CFile(CodeFile):
    ...
    def __init__(self):
        ...
        sketch_contents = getattr(self.CodeFile, 'sketch').getanyText()
        if sketch_contents == "":
        # Initialize Arduino Sketch contents if blank
            sketch_str = """
void sketch_setup()
{
...
"""
    ...
    def CTNGenerate_C(self, buildpath, locations):
        ...
        for variable in self.CodeFile.variables.variable:
            ...
            text += "extern \"C\" %(type)s %(global)s;\n" % var_infos
            text += "#define %(name)s %(global)s.value\n" % var_infos
        text += "\n"

        # Adding user sketch
        text += "/* User sketch */\n"
        text += self.CodeFile.sketch.getanyText().strip()
        text += "\n#endif\n"
